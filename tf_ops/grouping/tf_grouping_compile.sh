...
g++ -std=c++11 \
tf_grouping.cpp \
tf_grouping_g.cu.o -o \
tf_grouping_so.so -shared -fPIC \
-I ~/.conda/envs/tf36/lib/python3.6/site-packages/tensorflow/include \
-I /usr/local/cuda \
-I /usr/local/cuda/include \
-I ~/.conda/envs/tf36/lib/python3.6/site-packages/tensorflow/include/external/nsync/public -lcudart \
