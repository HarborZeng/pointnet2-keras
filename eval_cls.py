...
TRAIN_DATASET = modelnet_h5_dataset.ModelNetH5Dataset(
    'data/modelnet40_ply_hdf5_2048/train_files.txt', batch_size=batch_size,
...
def eval_one_epoch(sess, ops, num_votes=1):
    ...
    print('eval mean loss: %f' % (loss_sum / batch_idx))
    print('eval accuracy: %f' % (total_correct / total_seen))
